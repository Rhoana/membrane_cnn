...
# IMPORTANT - this is the even crop version
print "----- Even Crop Sampling ----- "
...
for imgi in range (zrad, nimages-zrad):
	...
	while train_i < train_target or valid_i < valid_target or test_i < test_target:
		...
		for zoffset in range(zd):
			...
			samp_vol[:,:,zoffset] = sample_img[min_border-imgrad:min_border+imgrad, min_border-imgrad:min_border+imgrad]
