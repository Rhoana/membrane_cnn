...
class LGN(dense_design_matrix.DenseDesignMatrix):
    def __init__(self, which_set, imgd=31, zd=1, ds=1, center = False, shuffle = False,
        ...
        if control.get_load_data():
            ...
            path = path + "LGN1_MembraneSamples_31x31x1_mp0.50_train50000_valid5000_test5000_seed11_ds4.pkl.gz"
            ...
            topo = dimshuffle(np.zeros((1,31,31,1)))
